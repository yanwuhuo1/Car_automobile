...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-header header">
        <div class="layui-main mag0">
            <a href="#" class="logo">汽车出租管理平台</a>
            <!-- 显示/隐藏菜单 -->
            <a href="javascript:" class="seraph hideMenu icon-caidan"></a>
            <!-- 顶级菜单 -->
            <ul class="layui-nav mobileTopLevelMenus" mobile>
                <li class="layui-nav-item" data-menu="contentManagement">
                    <a href="javascript:;"><i class="seraph icon-caidan"></i><cite>汽车出租管理平台</cite></a>
...
<%--                        <dd><a href="javascript:;" class="showNotice"><i class="layui-icon">&#xe645;</i><cite>系统公告</cite><span class="layui-badge-dot"></span></a></dd>--%>
    ...
    <div class="layui-footer footer">
        <p><span>copyright @2018 炎无惑</span>　　<a onclick="" class="layui-btn layui-btn-danger layui-btn-sm">捐赠作者</a></p>
    </div>
</div>
...
<script type="text/javascript" src="js/cache.js" charset="UTF-8"></script>
</body>
</html>